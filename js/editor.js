...
function showMsgTableItem(listItem) {
  var offsetTop = (listItem.offsetTop - msgList.scrollTop) - msgList.offsetTop;
  var offsetBottom = offsetTop + listItem.offsetHeight - msgList.offsetHeight;
  if (offsetTop < 0)
    msgList.scrollTop += offsetTop;
  else if (offsetBottom > 0)
    msgList.scrollTop += offsetBottom;
}
